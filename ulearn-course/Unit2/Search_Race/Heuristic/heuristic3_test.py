...
class Heuristic3Tests(unittest.TestCase):
    def test_two_points(self):
        ...
        if Visualize:
            app = QApplication([])
            visualizer = Visualizer(app, s, heuristic3, laps_number=laps_number, heuristic_number=3)
    ...
    def test_zig_zag(self):
        ...
        if Visualize:
            app = QApplication([])
            visualizer = Visualizer(app, s, heuristic3, laps_number=3, heuristic_number=3)
    ...
    def test_three_random(self):
        ...
        if Visualize:
            app = QApplication([])
            visualizer = Visualizer(app, s, heuristic3, 2)
